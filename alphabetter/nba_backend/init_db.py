...
from alphabetter.nba_backend.models import PlayerStats, PlayerStatsCalculated  # Use relative import
...
# Base.metadata.drop_all(bind=engine, tables=[PlayerStatsCalculated.__table__])
